...
router.route("/auth/google").get(
  oauthLimiter,
  // FIX: Scope must be an array for passport-google-oauth20 to properly send it to Google
...
router.route("/auth/google/callback").get(
  ...
  passport.authenticate('google', { 
    session: false, 
    // FIX: Add safe fallback for FRONTEND_URL to prevent undefined in failure redirect
