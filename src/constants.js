...
export  const ORDER_STATUS = ['pending', 'processing', 'completed', 'cancelled', 'returned'];
export  const PAYOUT_STATUS = ['pending', 'released', 'hold', 'failed'];
export  const REFUND_STATUS = ['pending', 'approved', 'rejected', 'refunded'];
...
export  const SUPPORT_STATUS = ['open', 'closed'];
